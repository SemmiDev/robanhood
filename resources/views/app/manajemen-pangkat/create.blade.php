...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('manajemenPangkat.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="grup" class="form-label">Nama Grup</label>
                            <span class="text-danger"> *</span>
                            <input list="grup-list" class="form-control" id="grup" autofocus autocomplete="off"
                                name="grup" placeholder="Perwira Tinggi (Pati)" required>
