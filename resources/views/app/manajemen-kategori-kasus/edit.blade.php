...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('manajemenKategoriKasus.update', $kategoriKasus->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <input autocomplete="off" list="nama-list" class="form-control" id="nama" name="nama"
                                value="{{ old('nama', $kategoriKasus->nama) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="deskripsi" id="deskripsi" rows="3" placeholder="Masukkan deskripsi">{{ old('deskripsi', $kategoriKasus->deskripsi) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="pengingat" class="form-label">Pesan Pengingat</label>
                            <textarea class="form-control" name="pengingat" id="pengingat" rows="3" placeholder="Masukkan pesan pengingat">{{ old('pengingat', $kategoriKasus->pengingat) }}</textarea>
                        </div>
                        <div class="text-end">
