...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Kasus coordinates
            const kasusCoords = [{{ $kasus->user->latitude_terakhir }}, {{ $kasus->user->longitude_terakhir }}];
            ...
            <div class="pulse-container">
                <div class="pulse"></div>
                <img src="/sos.png" alt="Kasus" width="40" height="40" />
            </div>
        `,
                    iconSize: [40, 40],
                    popupAnchor: [0, -20]
            ...
            const kasusPopupContent = `
                <div class="p-3">
                    ...
                    <p class="mb-1"><strong>Kategori:</strong> {{ $kasus->kategori_kasu->nama ?? 'SOS' }}</p>
                    <div class="mt-2">
